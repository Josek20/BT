...
function makeplotFinall(model,name)
    ...
    Plots.plot!(p1, -3f0:0.013f0:3, f, ylims=range,line=(:dash,2),label="Truth",legend=:bottom)
...
Plots.plot!(-3f0:0.013f0:3, f, ylims=range,line=(2),label="Truth",legend=:bottom)
